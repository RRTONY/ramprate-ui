...
- [ ] Inspect and restore the legacy Kumbaya public page with verified content, route behavior, and current RampRate public styling, without changing master or exposing private data.
...
- [ ] Complete the Kumbaya page’s verified live-page contract, including B Lab and Sprout Social links plus the remaining relevant intake-detail fields, with focused route coverage.
...
- [x] Replace Flow Monroe Protocol Framer Motion disclosure, audio-progress, and quiz-result feedback with reduced-motion-safe CSS while preserving science disclaimers, playback controls, quiz state, and reset behavior.
...
- [x] Compare current master SEO safeguards with the managed-content feature branch and selectively adopt compatible protections without reintroducing Sanity.
- [x] Audit all current live RampRate public pages against the feature branch, beginning with homepage content differences, and apply verified parity updates without changing master or regressing the independent CMS.
...
- [x] Modernize the Payments Advisory overview, intelligence, and intake surfaces with the shared typography and navy-paper-gold system while preserving form fields, submission behavior, public route SEO, and specialist payment content.
- [x] Modernize the BioChain overview, catalogue, process, buyer intake, and supplier intake surfaces with the shared typography and visual system while preserving specialist source content, form fields, submission behavior, and public route SEO.
- [x] Normalize the Process and Sourcing Process route visual systems to navy, paper, and controlled gold; remove competing multicolor accents and replace the unsupported final "Tell Us What’s Broken" treatment with the approved Book a Call action without altering process content or anchors.
