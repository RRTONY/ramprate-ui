...
- [ ] Replace Flow Family Dynamic Framer Motion with reduced-motion-safe CSS while preserving assessment loading, calculated family-map positions, activation controls, reports, links, and stress insights.
