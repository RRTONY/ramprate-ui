...
- [ ] Replace Flow Coaching Framer Motion header, generated-prompt, and empty-state feedback with reduced-motion-safe CSS while preserving authentication, context controls, AI generation, prompt data, and reset behavior.
