        ...
        <Card className="bg-white/80 backdrop-blur-xl border-black/5 shadow-xl h-full">
          <CardHeader>
            ...
            <p className="text-muted-foreground">
              Adjust the sliders to estimate the annual cost of &quot;invisible
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="font-bold flex items-center gap-2">
                  <Clock className="h-4 w-4 text-orange-500" /> Wasted Hours /
                  Week
                </label>
                <span className="text-2xl font-mono font-bold">
                  {frictionHours} hrs
              ...
              <p className="text-xs text-muted-foreground">
                *Includes useless meetings, waiting for approvals, and
          ...
          <CardContent className="relative z-10 p-8 flex flex-col justify-between h-full">
            ...
            <div className="space-y-3 mt-4">
              ...
              <p className="text-[11px] text-gray-500 pt-1">
                Illustrative split based on common patterns we see in
                role-misaligned teams - not measured from your specific
                team&#39;s data. The total above is calculated directly from
                your inputs.
              </p>
            </div>
