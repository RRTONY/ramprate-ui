...
export default function FrictionCostCalculator() {
  ...
  const calculateCost = () => {
    ...
    const weeklyFrictionCost =
      teamSize * hourlyRate * meetingHours * (frictionLevel / 100);
    ...
    <Card className="w-full max-w-4xl mx-auto bg-card/30 backdrop-blur-md border-white/10 shadow-2xl overflow-hidden">
      ...
      <CardHeader className="text-center pb-8">
        ...
        <CardDescription className="text-lg">
          Calculate how much misaligned energy is costing your organization
          annually.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="grid md:grid-cols-2 gap-12 p-8">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex justify-between">
              <Label className="text-lg font-medium flex items-center gap-2">
                <DollarSign className="h-4 w-4 text-green-500" /> Avg. Annual
                Salary
              </Label>
          ...
          <div className="space-y-4">
            <div className="flex justify-between">
              <Label className="text-lg font-medium flex items-center gap-2">
                <AlertTriangle className="h-4 w-4 text-orange-500" /> Friction
                Level
              </Label>
            ...
            <p className="text-xs text-muted-foreground">
              Percentage of meeting time wasted on circular debates,
              misunderstandings, and re-explaining.
            </p>
            <Slider
              value={[frictionLevel]}
