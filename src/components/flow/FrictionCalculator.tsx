...
export default function FrictionCalculator() {
  ...
  const annualFrictionCost =
    totalPayroll * collaborationFactor * (frictionLevel / 100);
      ...
      <CardContent className="p-6 space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between">
            <Label className="text-gray-400">
              Estimated Friction (Misalignment %)
            </Label>
          ...
          <p className="text-xs text-gray-500">
            *Based on typical &quot;Circuit Breaks&quot; (e.g., Spark ideas
            dying in Filter review, Ground waiting for clear specs).
          </p>
        </div>
        ...
        <div className="bg-red-900/10 border border-red-500/30 rounded-xl p-6 text-center space-y-2">
          ...
          <div className="flex items-center justify-center gap-2 text-red-300 text-sm mt-2">
            ...
            <span>
              That&#39;s {Math.round((annualFrictionCost / totalPayroll) * 100)}
              % of your total payroll burned.
            </span>
          </div>
        </div>
