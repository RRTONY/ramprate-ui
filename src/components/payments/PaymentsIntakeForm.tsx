...
import {
  PAYMENTS_INDUSTRIES,
  PAYMENTS_SECTIONS,
} from "@/lib/payments-advisory-data";
...
const HOW_HEARD_OPTIONS = [
  ...
  "Press / Media",
  "Direct outreach from RampRate",
  "Other",
];
const NDA_OPTIONS = [
  "Yes - please send your NDA",
  "Yes - we have our own NDA to share",
  "No - comfortable proceeding without",
...
const DECISION_ROLE_OPTIONS = [
  ...
  "Key influencer - board/exec approves",
  "Evaluating on behalf of finance team",
  "IT / Technical lead",
  "Procurement / Sourcing lead",
  "Consultant representing client",
];
const PAIN_POINT_OPTIONS = [
  "High rates / opaque pricing",
  "Low approval rates",
  ...
  "N/A - first-time merchant account",
];
const SWITCH_REASON_OPTIONS = [
  "Cost reduction",
  "Better approval rates",
  "Better support & relationship",
  "International expansion",
  "Redundancy / risk management",
  "Current processor exiting our category",
  "Board / investor directive",
  "Consolidating multiple processors",
  "Proactive benchmarking - not unhappy",
  "Forced - termination or hold",
];
const TERMINATION_OPTIONS = ["No", "Yes - will explain in notes"];
const API_INTEGRATION_OPTIONS = [
  "Full API team - can build any integration",
  "External dev resources available",
  "Limited - prefer hosted payment pages / iframes",
  "No technical capacity - need turnkey solution",
];
const MOBILE_PAYMENTS_OPTIONS = [
  "Yes - iOS and Android SDKs",
  "Yes - iOS only",
  "Yes - Android only",
  "Mobile web only (no native app)",
  "No",
];
const RECURRING_BILLING_OPTIONS = [
  "Yes - core business",
  "Yes - secondary revenue stream",
  "No",
  "On the roadmap",
];
const SUBSCRIPTION_MODEL_OPTIONS = [
  "SaaS - monthly/annual seats",
...
const ORCHESTRATION_NEED_OPTIONS = [
  "Yes - required",
  "Yes - actively evaluating",
  "No - single processor fine",
  "Not sure - educate me",
];
const ORCHESTRATION_GOAL_OPTIONS = [
  "Maximize approval rates",
  "Cost optimization",
  "Processor redundancy / failover",
  "Geographic / currency routing",
  "Intelligent retry logic",
  "All of the above",
  "N/A",
];
const REDUNDANCY_OPTIONS = [
  "Yes - minimum 2 active processors",
  "Yes - 3 or more",
  "No - acceptable risk",
  "Nice to have, not required",
];
const TOKENIZATION_OPTIONS = [
  "Active - Visa/MC network tokens",
  "In progress",
  "Not yet - interested",
  "Don't know what this is",
];
const PCI_COMPLIANT_OPTIONS = [
  "Yes - current attestation",
  "No - non-compliant",
  "In progress",
  "Not sure",
];
const PCI_LEVEL_OPTIONS = [
  "SAQ A (redirected / iFrame)",
  "SAQ A-EP (script injection)",
  "SAQ B (dial-up terminals)",
  "SAQ C (payment app)",
  "SAQ D (full cardholder data)",
  "Level 1 - QSA audit required",
];
const BREACH_OPTIONS = [
  "No",
  "Yes - disclosed to card brands",
  "Yes - occurred, investigation ongoing",
];
const AML_OPTIONS = [
  "Yes - bank-grade",
  "Yes - basic / policy only",
  "No - not required for our model",
  "Unsure",
];
const KYC_OPTIONS = [
  "Yes - automated (API)",
  "Yes - manual review",
  "Partial - select transactions",
  "No - B2B only / not applicable",
];
const LOCAL_ACQUIRING_OPTIONS = [
  "Yes - EU / EEA",
  "Yes - UK",
  "Yes - APAC",
  "Yes - LATAM",
...
const CB_TREND_OPTIONS = [
  "Stable - consistent for 12+ months",
  "Improving - trending down",
  "Worsening - trending up",
  "Seasonal - varies significantly",
  "N/A - new merchant",
];
const THREE_DS_OPTIONS = [
  "Yes - on all transactions",
  "Yes - on high-risk only",
  "No",
  "Evaluating",
  "Required by our market (EU PSD2)",
];
const RISK_TOLERANCE_OPTIONS = [
  "Conservative - minimize fraud above conversion impact",
  "Balanced - optimize approval rate vs. fraud loss",
  "Growth-first - maximize conversions, accept some fraud",
  "Depends on product / channel",
];
const CB_DISPUTE_OPTIONS = [
  "Fully in-house - dedicated team",
  "In-house but under-resourced",
  "Outsourced - existing supplier",
  "No formal process - need help",
  "Using processor's built-in tools",
];
const PRICING_MODEL_OPTIONS = [
  "Interchange Plus - transparent cost-plus (recommended at $50M+)",
  "Flat Rate - predictable, slightly higher",
  "Membership / Subscription (Stax-style) - fixed monthly + interchange",
  "Tiered - common but rarely favorable",
  "No preference - show me the analysis",
];
const CONTRACT_LENGTH_OPTIONS = [
  "Month-to-month (maximum flexibility)",
  "1 year",
  "2 years",
  "3 years - willing for the right deal",
  "Open to negotiation",
];
const ANNUAL_REVIEW_OPTIONS = [
  "Yes - annual review clause is non-negotiable",
  "Yes - preferred but flexible",
  "No - happy to lock in for contract term",
  "Depends on rate lock guarantee",
];
const RESERVE_OPTIONS = [
  "Yes",
  "No - hard no",
  "Depends on % and duration",
  "Not sure what this is",
];
const TIMELINE_OPTIONS = [
  "ASAP - 30 days or less",
  "60 days",
  "90 days",
  "6 months",
  "Exploring - no hard deadline",
];
const REVIEW_CADENCE_OPTIONS = [
  ...
  "Semi-annual",
  "Annual only",
  "Ad hoc - contact us when needed",
];
const CO_MARKETING_OPTIONS = [
  "Yes - open to being a reference client",
  "Yes - case study only, no press",
  "No - prefer confidentiality",
  "Discuss post-launch",
];
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      ...
      <TextField
        ...
        label="Title"
        required
        placeholder="CFO / VP Finance / CEO / Controller"
      />
      <TextField
        formik={formik}
        name="ownerEmail"
      ...
      <SelectField
        formik={formik}
        name="howHeard"
        label="How Did You Hear About RampRate?"
        options={HOW_HEARD_OPTIONS}
      />
      <TextField
        formik={formik}
        name="referredBy"
        label="Referred By (if applicable)"
        placeholder="Name and company of referrer"
      />
      <SelectField
        formik={formik}
        name="ndaRequired"
      ...
      {formik.values.annualRevenue && revenue < 1000000 && (
        ...
        >
          Your stated revenue is below our $1M minimum. We may still be able to
          refer you to appropriate resources - continue completing the form and
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      <TextField
        ...
        hint="Required for processor applications - safe to share at this stage."
      />
      <TextField
        formik={formik}
        name="yearFounded"
      ...
      <SelectField
        ...
        required
        options={PAYMENTS_INDUSTRIES.map((i) => i.label)}
      />
      <SelectField
        formik={formik}
      ...
      <TextField
        ...
        placeholder="e.g. US, Canada, UK, EU, APAC..."
        hint="Where your customers are - not just where you're incorporated."
      />
      <SelectField
        formik={formik}
        name="decisionRole"
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      <TextField
        ...
        label="Current Monthly Processing Volume"
        type="number"
        required
        placeholder="e.g. 8000000"
        hint="Total card volume in USD per month across all processors."
      />
      <TextField
        formik={formik}
        name="projectedMonthlyVolume"
        label="Projected Monthly Volume (12mo)"
        type="number"
      ...
      <TextField
        ...
        required
        placeholder="e.g. 150"
        hint="Average single transaction in USD. Drives interchange category."
      />
      <TextField
        formik={formik}
        name="highestTicket"
        ...
        hint="Processors need to underwrite your maximum exposure per transaction."
      />
      <TextField
        formik={formik}
        name="cardMixCredit"
      ...
      <TextField
        ...
        label="Current Primary Processor"
        placeholder="e.g. Stripe, Worldpay, Chase..."
      />
      <TextField
        formik={formik}
        name="secondaryProcessor"
        label="Secondary Processor (if any)"
        placeholder="e.g. PayPal, Adyen... or None"
      />
      <TextField
        formik={formik}
        name="processingHistory"
        label="Years with Current Primary Processor"
        type="number"
        placeholder="e.g. 3"
      />
      <SelectField
      ...
      <SelectField
        formik={formik}
        name="hasTermination"
        label="Ever Terminated by a Processor?"
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      <TextField
        formik={formik}
        name="currentGateway"
        label="Current Payment Gateway"
        placeholder="e.g. Authorize.net, NMI, Spreedly, direct..."
      />
      <TextField
        formik={formik}
        name="gatewayContracts"
        label="Gateway Contract End Date"
        type="date"
        hint="Early termination fees are common - we factor this into your switching cost analysis."
      />
      <TextField
        formik={formik}
        name="ecommerceCart"
        label="E-Commerce Platform / Cart"
        placeholder="e.g. Shopify, WooCommerce, Magento, Custom..."
      />
      <TextField
        formik={formik}
        name="posSystem"
        label="POS System (if applicable)"
        placeholder="e.g. Square, Toast, Clover, NCR..."
      />
      <SelectField
        formik={formik}
        name="apiIntegration"
      ...
      <SelectField
        formik={formik}
        name="mobilePayments"
        label="Mobile Payments Required?"
        options={MOBILE_PAYMENTS_OPTIONS}
      />
      <SelectField
        formik={formik}
      ...
      <SelectField
        ...
        label="Primary Orchestration Goal"
        options={ORCHESTRATION_GOAL_OPTIONS}
      />
      <SelectField
        formik={formik}
        name="redundancy"
        label="Processor Redundancy Required?"
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      ...
      <SelectField
        ...
        name="pciLevel"
        label="PCI SAQ / Level"
        options={PCI_LEVEL_OPTIONS}
      />
      <TextField
        formik={formik}
        name="lastAudit"
        label="Last PCI Audit / Attestation Date"
        type="date"
      />
      <SelectField
        formik={formik}
      ...
      <TextField
        formik={formik}
        name="countries"
        label="Countries You Accept Payments From"
        required
        placeholder="e.g. USA, Canada, UK, EU, Australia..."
        hint="List all - not just where you're incorporated."
      />
      <TextField
        formik={formik}
        name="currencies"
        label="Currencies You Accept"
      ...
      <SelectField
        formik={formik}
        name="localAcquiring"
        label="Local Acquiring Needed?"
        options={LOCAL_ACQUIRING_OPTIONS}
      />
      <TextAreaField
        formik={formik}
...
function Step5({ formik }: StepProps) {
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      ...
      <SelectField
        formik={formik}
        name="chargebackTrend"
        label="Chargeback Rate Trend"
        options={CB_TREND_OPTIONS}
      />
      <TextField
        formik={formik}
        name="fraudToolCurrent"
        label="Current Fraud Tool / Supplier"
        placeholder="e.g. Kount, Signifyd, Riskified, Stripe Radar, in-house rules engine, none..."
      />
      <TextField
        formik={formik}
        name="fraudBudget"
        label="Monthly Fraud & Risk Budget (USD)"
        type="number"
      ...
      <SelectField
        formik={formik}
        name="threeDSEnabled"
        label="3D Secure 2.0 (3DS2) Active?"
      ...
      <SelectField
        ...
        label="Chargeback Dispute Management"
        options={CB_DISPUTE_OPTIONS}
      />
      <TextField
        formik={formik}
        name="cbMgmtSupplier"
        label="Current CB Management Supplier (if any)"
        placeholder="e.g. Chargebacks911, DisputeHelp, Ethoca, Verifi, none..."
      />
    </div>
  );
}
...
function Step6({ formik }: StepProps) {
  return (
    <div className="grid sm:grid-cols-2 gap-5">
      <Callout>
        RampRate&apos;s model is built on long-term supplier relationships - not
        one-time placements. The questions below help us match you with
        processors whose service model, contract structure, and account
        management approach fit your operating style for the next 3-5 years, not
        just your rates today.
      </Callout>
      <SelectField
        formik={formik}
        name="pricingModel"
      ...
      <TextField
        formik={formik}
        name="reservePercent"
        label="Maximum Reserve % (if acceptable)"
        type="number"
        placeholder="e.g. 5"
      />
      <SelectField
        formik={formik}
        name="switchTimeline"
        label="Target Activation Timeline"
...
function ProgressBar({ active }: { active: number }) {
  ...
  const minutesRemaining = STEP_MINUTES.slice(active).reduce(
    (a, b) => a + b,
    0,
  );
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-3 gap-4">
        <p
          ...
          style={{ color: "oklch(0.5 0.06 60)" }}
        >
          Section {active + 1} of {PAYMENTS_SECTIONS.length} -{" "}
          {PAYMENTS_SECTIONS[active]}
        </p>
        <p
          className="text-xs font-semibold shrink-0"
          style={{ color: "oklch(0.52 0.15 50)" }}
        >
  ...
  lines.forEach((line, i) => {
    if (line.startsWith("# ")) {
      blocks.push(
        <h2
          key={i}
          className="text-xl font-bold mt-8 mb-3 pb-2 border-b-2"
          style={{
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ background: "white", border: "1px solid oklch(0.9 0.01 70)" }}
      >
        {blocks}
      </div>

      <div
        className="rounded-2xl p-8 mt-8 flex justify-between items-center flex-wrap gap-6"
      ...
      >
        <div>
          ...
          <p className="text-sm text-white/60 max-w-lg">
            ...
            refining this RFP, distributing it to matched processors under our
            letterhead, scoring every response, and negotiating on your behalf.
            You never deal with processor sales reps directly.
          </p>
        </div>
        {confirmed ? (
          <div
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        setError(
          "Something went wrong submitting your intake. Please try again or email us directly.",
        );
      } finally {
        setSubmitting(false);
      }
  ...
  if (submitting) {
    return (
      <div className="text-center py-24 px-5">
        ...
        >
          This usually takes 60–90 seconds - the final version will be authored
          and refined by your RampRate advisor before it&apos;s distributed to
          any processor. Please don&apos;t close this tab.
        </p>
      </div>
    );
  }
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        {isLast ? (
          ...
          <button
            type="button"
            onClick={() =>
              goToStep(Math.min(PAYMENTS_SECTIONS.length - 1, active + 1))
            }
