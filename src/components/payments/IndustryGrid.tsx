      ...
      {PAYMENTS_INDUSTRIES.map((ind) => {
        ...
        return (
          <button
            ...
            className="rr-payments-industry-card text-left rounded-xl p-5 transition-all"
            style={{
              background: "white",
          ...
          >
            ...
            {isSelected && (
              <div
                className="mt-4 pt-4"
                style={{ borderTop: "1px solid oklch(0.9 0.01 70)" }}
              >
                <div
