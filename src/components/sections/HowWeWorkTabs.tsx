...
const links = [
  {label: 'Who We Are',             href: '/about',           desc: 'Team, values, 25-year track record',                    external: false},
  {label: 'How We Work',            href: '/expertise',       desc: 'Compensation model, delivery practices',                external: false},
  {label: 'B Corp Certification',   href: '/ramprate-is-b-certified-corp-the-accolade-is-a-clear-sign-our-business-is-on-the-right-track', desc: 'Verified transparency — top 4,000 globally', external: false},
  {label: 'Client Proof',           href: '/proof',           desc: 'Real results, named clients, no spin',                  external: false},
  {label: 'Client List',            href: '/it-sourcing/clients', desc: '250+ enterprise engagements',                       external: false},
...
export default function HowWeWorkTabs() {
  ...
  return (
    <div>
          ...
          {tabs.map(tab => (
            <button
              ...
              style={{
                ...
                color: activeTab === tab.id ? 'oklch(0.82 0.15 75)' : 'rgba(255,255,255,0.35)',
                borderBottomColor: activeTab === tab.id ? 'oklch(0.82 0.15 75)' : 'transparent',
      ...
      {/* ── Process Tab ── */}
      {activeTab === 'process' && (
        <section className="py-16 sm:py-20 px-5 sm:px-8" style={{background: 'var(--dark)'}}>
          <div className="max-w-7xl mx-auto">
            <div className="max-w-3xl mx-auto">
              ...
              <div
                ...
                style={{background: 'rgba(212,168,67,0.06)', borderLeftColor: 'oklch(0.82 0.15 75)'}}
              >
                <p
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                {feeItems.map((item, i) => (
                  <div
                    ...
                    style={{
                      background: item.primary ? 'rgba(212,168,67,0.06)' : 'rgba(255,255,255,0.03)',
                      borderColor: item.primary ? 'rgba(212,168,67,0.25)' : 'rgba(255,255,255,0.07)',
                    }}
                  >
              ...
              >
                ...
                >
                  <span
                    ...
                    style={{color: 'oklch(0.82 0.15 75)', fontFamily: 'var(--font-display)'}}
                  >
                    B
                  </span>
                </div>
                ...
                {links.map((link, i) => {
                  const inner = (
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="shrink-0 mt-0.5" style={{color: 'rgba(255,255,255,0.2)'}}>
                        {link.external ? <ExternalIcon /> : <ArrowRight />}
                      </span>
                    </div>
                  )

                  const cardClass = 'rounded-lg p-5 border block group transition-colors hover:border-[rgba(212,168,67,0.3)]'
                  const cardStyle = {background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.07)'}

                  return link.external ? (
                    <a key={i} href={link.href} target="_blank" rel="noreferrer" className={cardClass} style={cardStyle}>
                      {inner}
                    </a>
                  ) : (
                    <Link key={i} href={link.href} className={cardClass} style={cardStyle}>
                      {inner}
                    </Link>
                  )
                })}
