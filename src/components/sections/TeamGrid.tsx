        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {members.map((member, i) => (
            <div key={i} className="text-center">
              ...
              <p className="font-body text-sm mb-3 text-white/45">
                {member.role}
              </p>
              {member.linkedin && (
                <a
                  ...
                  className="font-body inline-flex items-center gap-1.5 text-xs font-medium transition-opacity hover:opacity-70 text-gold"
                >
