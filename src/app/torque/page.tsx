...
const FALLBACK_METADATA: Metadata = {
  ...
  description:
    "Torque sources and coordinates the specialists a high-stakes dispute requires, without entering privileged strategy conversations that belong to your attorney.",
  keywords: [
...
export default function TorquePage() {
  return (
    <main>
      <JsonLd
        data={serviceJsonLd({
          name: "Torque - RampRate",
          description:
            "Sources and coordinates the specialists a high-stakes dispute requires without stepping into privileged strategy conversations that belong to your attorney.",
          url: "https://ramprate.com/torque",
          serviceType:
