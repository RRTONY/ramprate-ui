...
const FALLBACK_METADATA: Metadata = {
  title: "Talk to Us",
  description:
    "Big moves. Clear thinking. Tell RampRate what you’re seeing and hear back from a real person within five business days.",
      ...
      <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-20 overflow-hidden bg-dark">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 sm:px-8 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-semibold leading-tight text-white mb-5">
            Big moves.
            <br />
            Clear <span className="text-gold">thinking.</span>
          </h1>
          ...
          <p className="font-mono text-xs text-gold/80 mb-1.5">
            $1B+ in contracts sourced and negotiated &middot; 40+ founders taken
            from idea to real business &middot; $3M+ in grant funding raised
          </p>
          <p className="font-mono text-xs text-white/40">
            Trusted by Microsoft, Disney, CBS, Nike &middot; B Corp &middot; 2X
            Return Guarantee
          </p>
        </div>
      </section>
