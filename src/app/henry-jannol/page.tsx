...
const protocol = [
  {
    ...
    standard: "Email for all formal communications",
    owner: "Both",
  },
  {
  ...
  {
    element: "Billing Response",
    standard:
      "Itemized response to all disputed charges within 5 business days",
    owner: "Henry",
  },
  {
    element: "File Transfer",
    standard:
      "All materials transferred within 10 business days of written request",
    owner: "Henry",
  },
  {
    element: "Confirmation",
    standard: "Written confirmation required for all transfers and resolutions",
    owner: "Both",
  },
];

export default async function HenryJannolPage() {
  const unlocked = await isPortalUnlocked("henry-jannol");

  if (!unlocked) {
    return <PortalGate portalId="henry-jannol" />;
  }
      ...
      >
        ...
        <div className="flex justify-between items-start flex-wrap gap-4 pb-6 mb-9 border-b-2 border-black">
          ...
          <div className="text-right text-sm leading-loose text-gray-600">
            ...
            <div>
              <strong className="text-black">To:</strong> Henry Jannol, Esq.
            </div>
            <div>
              <strong className="text-black">Re:</strong> Co-Counsel Transition
              &amp; Open Issues
            </div>
            <div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-sm">
            I want to be direct and professional about the transition we need to
            complete. There are several open items that require resolution as we
            move forward with new counsel on the Greenberg v. Hayek matter. This
            document is my first attempt to capture all outstanding issues in
            one place - it is not accusatory and makes no assumptions. I believe
            it is approximately 90% correct and I welcome your input to improve
            it.
          </p>
          <p className="leading-relaxed text-sm">
            The goal here is clean and complete - a proper transition that
            protects the case, resolves any billing questions with full
            transparency, and allows us both to move forward without loose ends.
            I would like your written response to each item below.
          </p>
        ...
        <div className="pt-2 border-t-2 border-black">
          <p className="mb-4 text-sm leading-relaxed">
            Henry, I hold no animosity and have no interest in anything other
            than a clean, professional resolution. I have built my businesses on
            the principle that tight process and honest communication produce
            the best outcomes - and I apply that standard to every professional
            relationship, including transitions.
          </p>
          <p className="mb-6 text-sm leading-relaxed">
            Please confirm receipt and provide your written response to each
            item above within the timelines specified.
          </p>
          <div
