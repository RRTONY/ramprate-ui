...
export default async function ThinkingPage() {
  const posts: ThinkingPost[] =
    (await client.fetch(allThinkingPostsQuery)) ?? [];
    ...
    <main style={{ background: "var(--dark)", minHeight: "100vh" }}>
      ...
      >
        <div className="max-w-4xl mx-auto px-5 sm:px-8">
          <div
            className="flex items-center gap-5 p-6 rounded-xl border border-white/10"
          ...
          >
            ...
            <div>
              ...
              <div
                className="text-xs text-[oklch(0.82_0.15_75)] mb-1"
                style={{ fontFamily: "var(--font-body)" }}
              >
                Founder & CEO · Published since 2010
              </div>
              <p
                className="text-white/50 text-sm"
                style={{ fontFamily: "var(--font-body)" }}
              >
                25 years at the intersection of enterprise IT, blockchain, and
                conscious business. Harvard, USC, Forbes, Business Insider.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16" style={{ background: "#0d1117" }}>
        <div className="max-w-4xl mx-auto px-5 sm:px-8">
          {posts.length === 0 && (
            <p
              className="text-white/60 text-sm bg-white/5 px-4 py-3 rounded-lg inline-block"
              style={{ fontFamily: "var(--font-body)" }}
            >
              ...
              <div className="space-y-1">
                {grouped[year].map((post) => (
                  <article key={post._id}>
                    ...
                    >
                      <div
                        className="text-xs text-white/30 pt-0.5 shrink-0 w-16 text-right"
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {post.excerpt && (
                          <p
                            className="text-white/35 text-sm mt-1 line-clamp-1"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            {post.excerpt}
                          </p>
                      ...
                      <svg
                        ...
                        stroke="currentColor"
                        strokeWidth="2"
                        className="text-white/20 group-hover:text-[oklch(0.82_0.15_75)] shrink-0 mt-0.5 transition-colors"
                      >
      ...
      >
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          <p
            className="text-xs font-semibold tracking-[0.2em] uppercase text-[oklch(0.82_0.15_75)] mb-4"
            style={{ fontFamily: "var(--font-mono)" }}
          >
            A thought for you
          </p>
