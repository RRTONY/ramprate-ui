        ...
        <div className="max-w-5xl mx-auto px-4 py-16 space-y-16">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Be one of <strong className="text-white">10 companies</strong> to
            ...
            {[
              {
                ...
                description:
                  "Each team member takes a 2-minute test to discover their dominant operational role (Spark, Amplifier, Filter, Ground, or Conductor).",
              },
              {
                icon: <BarChart3 className="w-8 h-8" />,
                title: "Group Dynamic Report",
                description:
                  "See your entire team plotted on the Energy Matrix. Identify gaps, friction points, and hidden strengths at a glance.",
              },
              {
                icon: <Brain className="w-8 h-8" />,
                title: "Soulprint Integration",
                description:
                  "Optional: Add birth data to unlock a deeper Soulprint analysis synthesizing 8 personality and cosmic frameworks.",
              },
            ].map((feature, i) => (
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-2xl max-w-xl mx-auto space-y-4">
              ...
              <div className="space-y-3 text-left text-gray-300">
                <div className="flex items-start gap-3">
                  <span className="bg-yellow-400 text-black w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                    1
                  </span>
          ...
          <Card className="bg-white/5 border-white/10">
            <CardContent className="pt-8 space-y-6">
              ...
              <p className="text-xs text-gray-500 text-center">
                Alpha teams support up to 25 members.
              </p>
            </CardContent>
          </Card>
        </div>
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-8">
        ...
        <Card className="bg-yellow-400/5 border-yellow-400/30">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Anyone who uses this link will automatically join your team. Their
            ...
            <CardContent className="space-y-4">
              ...
              >
                {copied === "slack" ? (
                  ...
                  <span className="flex items-center gap-2">
                    <Copy className="w-4 h-4" /> Copy Slack Message
                  </span>
                )}
              </Button>
            </CardContent>
              ...
              {[
                {
                  step: "01",
                  title: "They Click",
                  desc: "Staff member opens your unique link",
                },
                {
                  step: "02",
                  title: "They Assess",
                  desc: "2-minute test maps their operational role",
                },
                {
                  step: "03",
                  title: "They Share",
                  desc: "They get their individual report + feedback form",
                },
                {
                  step: "04",
                  title: "You Visualize",
                  desc: "Their dot appears on your Team Matrix",
                },
              ].map((item) => (
                <div
                  key={item.step}
                ...
                >
                  <div className="text-3xl font-black text-gray-700 mb-2">
                    {item.step}
                  </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          ...
          <Button
            onClick={() =>
              (window.location.href = `/assessment?team=${createdTeam.code}`)
            }
            variant="outline"
