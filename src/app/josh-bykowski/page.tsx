...
export default async function JoshBykowskiPage() {
  const unlocked = await isPortalUnlocked("josh-bykowski");

  if (!unlocked) {
    return <PortalGate portalId="josh-bykowski" />;
  }
      ...
      >
        ...
        <div className="flex justify-between items-start flex-wrap gap-4 pb-6 mb-9 border-b-2 border-black">
          ...
          <div className="text-right text-sm leading-loose text-gray-600">
            ...
            <div>
              <strong className="text-black">To:</strong> Josh Bykowski, Esq.
            </div>
            <div>
              <strong className="text-black">Re:</strong> Matter Framework &amp;
              Open Issues
            </div>
            <div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-sm">
            I want to establish a proper working framework for all the matters
            we have running together. This is my first pass at capturing
            everything in one place - it is approximately 90% correct and I
            welcome your input to fill in what I have missed or gotten wrong.
            There are no accusations and no assumptions - this is simply the
            beginning of a system we will use together going forward.
          </p>
          <p className="leading-relaxed text-sm">
            I am building a broader CRM to manage all my legal relationships -
            one that will eventually allow us to share opportunities, flag
            conflicts, and coordinate on matters where our networks overlap. You
            are a valued part of that network. I look forward to cleaning up
            current issues and growing together.
          </p>
          <p className="mt-4 leading-relaxed text-sm">
            I have six active entrepreneur clients I am supporting right now and
        ...
        <div className="pt-2 border-t-2 border-black">
          <p className="mb-4 text-sm leading-relaxed">
            Josh, thank you for all your work to date. I appreciate your
            partnership and look forward to building a tighter, more connected
            working relationship as we grow together. The system we are putting
            in place will benefit both of us.
          </p>
          <p className="mb-6 text-sm leading-relaxed">
            Please review this document, confirm what is correct, correct what
            is not, and let&apos;s schedule a call to close out the open items
            together.
          </p>
          <div
