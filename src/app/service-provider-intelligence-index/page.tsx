...
export default function SpiiPage() {
  return (
    <div style={{background: 'var(--dark)', color: '#fff', fontFamily: 'var(--font-body)'}}>
      ...
      <section className="relative overflow-hidden pt-28 pb-20 px-5 sm:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <h1
            ...
            style={{fontFamily: 'var(--font-display)', fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: 1.1}}
          >
            Service Provider<br />
          ...
          >
            The SPY Index™ easily and quickly matches buyer needs with IT service providers in a
            vendor-neutral analysis — taking the guesswork out of vendor selection and contract
            negotiations.
          </p>
      ...
      <section className="py-20 px-5 sm:px-8" style={{background: 'oklch(0.14 0.01 250)'}}>
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="mb-5 text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                The SPY Index™ easily and quickly matches buyer needs with IT service providers in a
                vendor-neutral analysis. Configurable buying criteria matching ensures results are
                tailored to your exact operational and commercial requirements.
              </p>
              <p className="text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                More than <strong className="text-white">99% of the deals</strong> we facilitate
                for you make it to contract — because we come to the table with hard data, not
                guesswork.
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3">
                {[
                  ...
                  <div key={pt} className="flex items-start gap-3 text-sm" style={{color: 'rgba(255,255,255,0.65)'}}>
      ...
      <section className="py-20 px-5 sm:px-8" style={{background: 'var(--dark)'}}>
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="mb-4 text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                The SPY Index™ analyses the right mix of Cloud and legacy infrastructure with{' '}
                <strong className="text-white">315 variables</strong> and hundreds of sources —
                comparing <strong className="text-white">thousands of data points</strong> encompassing
                price, service levels, financial stability, cultural compatibility, and
                environmental considerations.
              </p>
              <p className="mb-8 text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                Built on more than <strong className="text-white">15 years of industry experience</strong>{' '}
                that has unlocked billions in savings and revenue opportunities for clients and
      ...
      <section className="py-20 px-5 sm:px-8 section-warm">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            >
              Five independent data sources — cross-referenced against your configurable buying
              criteria to deliver intelligence you can act on immediately.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  <div
                    ...
                    style={{background: 'rgba(100,60,30,0.1)', color: 'var(--rust)'}}
                  >
                    {pillar.icon}
                  </div>
                  <span
                ...
                <ul className="space-y-2">
                  {pillar.points.map((point) => (
                    <li
                      ...
                      style={{color: 'var(--text-mid)'}}
                    >
                      <span className="mt-1 shrink-0" style={{color: 'var(--rust)'}}>
      ...
      <section className="py-20 px-5 sm:px-8" style={{background: 'var(--dark)'}}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            >
              Near real-time intelligence built from two decades of actual transactions —
              not analyst estimates or survey responses.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="mb-5 text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                This massive database cross-references your highly configurable buying criteria
                against a comprehensive database of IT vendor and market information — for now
                and for the next 5 years.
              </p>
              <p className="mb-5 text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                It isn&apos;t an analyst report. It&apos;s a living database of what buyers actually
                paid — updated with every deal we close. When we tell you the market rate,
                we&apos;re not guessing.
              </p>
              <p className="text-base leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
                Procurement, mid-contract negotiations, and renewal savings average{' '}
                <strong className="text-white">23.8% over baseline data</strong> — with weeks or
                even months cut from your management and legal approval processes.
              </p>
            </div>
