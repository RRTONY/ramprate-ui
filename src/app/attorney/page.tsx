...
const protocol = [
  {
    element: "Primary Channel",
    standard: "WhatsApp for real-time; email for formal record",
    owner: "Both",
  },
  {
    element: "Response SLA",
    standard: "Same business day; urgent matters within 4 hours",
    owner: "Adam / Admin",
  },
  {
    element: "Weekly Status",
    standard: "Written update on all active matters every Monday",
    owner: "Adam's team",
  },
  {
    element: "Deadline Register",
    standard: "Shared master log maintained and updated in real time",
    owner: "Both",
  },
  {
    element: "Admin Contact",
    standard: "Please confirm name, direct line, and email of your admin",
    owner: "Adam",
  },
  {
    element: "Billing",
    standard: "Invoices within 48 hours of work performed; itemized",
    owner: "Adam's office",
  },
  {
    element: "Approvals",
    standard: "Written approval required for all strategic decisions",
    owner: "Tony",
  },
];

export default async function AttorneyPage() {
  const unlocked = await isPortalUnlocked("attorney");

  if (!unlocked) {
    return <PortalGate portalId="attorney" />;
  }
      ...
      >
        ...
        <div className="flex justify-between items-start flex-wrap gap-4 pb-6 mb-9 border-b-2 border-black">
          ...
          <div className="text-right text-sm leading-loose text-gray-600">
            <div>
              <strong className="text-black">Date:</strong> March 17, 2026
            </div>
            <div>
              <strong className="text-black">To:</strong> Adam Zaffos, Esq.
            </div>
            <div>
              <strong className="text-black">Re:</strong> Partnership Framework
              &amp; Active Matters
            </div>
            <div>
              <strong className="text-black">Status:</strong> Confidential
              Attorney-Client
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-sm">
            I want to start by saying directly: I intend for you to be one of
            the best client relationships you have ever had, and I expect the
            same standard in return. That begins with structure. We have several
            active matters running concurrently and the way we have been
            managing communication and accountability has been too informal
            relative to the stakes involved.
          </p>
          <p className="leading-relaxed text-sm">
            This letter establishes the working framework I want in place going
            forward - covering active matters, communication protocols,
            deadlines, the referral relationship through Paula (our mutual
            contact via Kodah), and the immediate actions required this week.
            Consider this our operating agreement as partners.
          </p>
        </div>
        ...
        <div className="rounded px-5 py-4 mb-6 text-sm leading-relaxed bg-gray-100 border border-black">
          <strong>Payment:</strong> You will receive a $10,000 payment from me
          by next Monday. This is contingent on the transfer of attorney of
          record being initiated this week. Please confirm receipt, apply it to
          the appropriate retainer or matter account, and send written
        ...
        <ul className="mb-6 space-y-2">
          {[
            ...
            <li
              key={i}
              className="flex items-start gap-2 pl-1 text-sm pb-2 border-b border-gray-200"
            >
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-2">
          {matters.map((m) => (
            <div
              key={m.track}
              className="rounded p-5 bg-gray-50 border border-gray-300 border-l-4 border-l-black"
            >
              ...
              <ul className="space-y-1 mb-3">
                {m.items.map((item, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-2 text-sm pb-1.5 border-b border-gray-200"
                  >
            ...
            <tbody>
              {protocol.map((row, i) => (
                <tr
                  key={i}
                  className={
                    i < protocol.length - 1 ? "border-b border-gray-200" : ""
                  }
                >
        ...
        <div className="rounded-lg p-6 bg-gray-100 border border-gray-300 space-y-3 text-sm leading-relaxed">
          <p>
            <strong>The introduction:</strong> Paula introduced us - she is a
            mutual friend who made the connection between me and your practice
            through the Kodah relationship. That introduction has value and
            deserves to be acknowledged openly.
          </p>
          <p>
            <strong>Open question - ongoing vs. one-time:</strong> I want
            clarity on whether Paula&apos;s role is limited to the initial
            introduction, or whether she has involvement in successive matters
            that flow from this relationship going forward. If she is actively
            involved in future referrals or matters, that changes the structure
            of any consideration.
          </p>
          <p>
            <strong>Open question - compensation/spiff:</strong> How is Paula
            compensated for this? Does she receive a referral fee on matters
            referred? A percentage? A flat spiff? Something in kind? I want to
            make sure she is properly acknowledged and that any arrangement is
            clearly defined, ethical, and compliant with bar rules.
          </p>
          <p>
            <strong>Open question - ongoing obligations:</strong> If additional
            clients or matters come through the Kodah network as a result of
            Paula&apos;s introduction, is there a continuing obligation to her?
            That should be defined now, not after the fact.
          </p>
          <p className="text-gray-600 italic">
            No action is mandated here. This is on the list for a direct
            conversation. I want it in the open because I believe every
            relationship deserves clarity, and I intend to honor every
            introduction that brings real value.
          </p>
        </div>
        ...
        <p className="mb-4 text-sm leading-relaxed">
          Based on your background and experience with consumer products
          matters, I have a representation opportunity I believe would be well
          suited to your practice. I am not in a position to bring this forward
          until our current matters are properly structured and moving. Consider
          this a strong incentive to get the foundation right quickly.
        </p>
        <p className="text-sm leading-relaxed">
          The opportunity is real, the relationship is warm, and it will come to
          you as a direct referral once I have confidence that our working
          relationship operates at the standard I hold for all my partnerships.
        </p>
        ...
        <div className="pt-2 border-t-2 border-black">
          <p className="mb-4 text-sm leading-relaxed">
            Adam, I am a demanding client because I take these matters seriously
            and because I have built two significant businesses on the principle
            that tight process creates the conditions for exceptional outcomes.
            I look forward to building that with you.
          </p>
          <p className="mb-6 text-sm leading-relaxed">
            Please confirm receipt of this letter, provide your admin&apos;s
        ...
        <div className="mt-16 pt-5 text-center text-xs leading-loose border-t border-gray-200 text-gray-500">
          CONFIDENTIAL - Attorney-Client Communication · Tony Greenberg · Santa
          Monica, CA
          <br />
