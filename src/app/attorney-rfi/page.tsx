      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          ...
          >
            ...
            commitment to helping entrepreneurs navigate complexity - so they
            can focus on the change they want to create in the world.
          </p>
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="bg-white rounded-xl p-12 border border-black/5 text-center">
                  ...
                  >
                    Thank you for your interest in RampRate&apos;s legal
                    network. One of our principals will review your application
                    ...
                    <div className="space-y-5">
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-md border text-sm focus:outline-none resize-none"
                          style={{
                            borderColor: "rgba(0,0,0,0.1)",
                            background: "oklch(0.97 0.01 80)",
                            fontFamily: "var(--font-body)",
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                ...
                >
                  RampRate founder Tony Greenberg has spent decades helping
                  entrepreneurs navigate legal complexity that consumed time
                  meant for building. This network is built on one principle: no
                  entrepreneur should face legal challenges alone.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                ...
                >
                  Reach out directly to discuss fit and partnership
                  opportunities before submitting the full application.
                </p>
                <Link
                  href="/contact"
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                ...
                >
                  See how RampRate works before applying to the network.
                </p>
                <div className="space-y-2">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 rounded-md text-xs font-bold transition-all w-full"
                    style={{
                      background: "rgba(100,60,30,0.07)",
                      color: "oklch(0.55 0.15 30)",
                      fontFamily: "var(--font-body)",
                    }}
                  >
