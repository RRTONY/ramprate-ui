    ...
    <main>
      ...
      <section className="relative section-warm overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          >
            <p>
              RampRate is a B Labs certified advisory firm with 25 years and
              $10B+ in enterprise decisions behind us. We are not your lawyer,
              your accountant, your publicist, or your investigator. But we work
              with all of them.
            </p>
            <p>
              Think of us as the person sitting above the table - making sure
              every professional you have engaged is pointed in the right
              direction, working from the same page, and focused on what
              actually matters to you. Most people in complex situations find
              themselves managing a roster of specialists who are each excellent
              in their lane but not talking to each other. We close that gap.
            </p>
            <p>
              We coordinate, we pressure-test, and when something falls through
              the cracks, we catch it. You should not have to be the one holding
              all of this together. That is what we are here for.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative section-light overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-14">
            ...
            >
              From crisis to growth, reputation to innovation - we bring the
              full range of expertise required for the moments that define
      ...
      <section className="relative section-dark overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            We work on a retainer plus a savings or success fee calculated
            against a mutually agreed baseline. That baseline is established
            together at the start of the engagement - with no ambiguity and no
            moving goalposts. Our success fee only triggers when we deliver
            measurable value above it. If we cannot create leverage for you, we
            will tell you that fast.
          </p>
            ...
            {[
              {
                label: "Structure",
                value:
                  "Retainer + savings or success fee against an agreed baseline",
              },
              {
                label: "Transparency",
                value: "Baseline established together at start - no ambiguity",
              },
              {
                label: "Accountability",
                value:
                  "Success fee only triggers when we deliver measurable value",
              },
            ].map((item) => (
              <div
                key={item.label}
      ...
      >
        <div className="max-w-4xl mx-auto px-5 sm:px-8 text-center">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            The next step is simple. We connect to confirm mutual fit, then
            draft a proposal outlining scope and commercial terms. Everything
            moves at your pace.
          </p>
