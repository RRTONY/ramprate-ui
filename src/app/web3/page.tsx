...
const relatedPosts = [
  ...
  {
    title:
      "UNI Token Price Surge: A Reflection of the Market's Hunger for Effective Governance?",
    date: "March 5, 2024",
  ...
  {
    title:
      "RampRate Works with DevxDAO and XPRIZE to Announce a Grant in Excess of €4 Million",
  ...
  return (
    <main>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, oklch(0.6 0.2 280), oklch(0.5 0.18 260))",
        }}
      >
      ...
      <section className="relative section-warm overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          >
            <p>
              Stratum bridges the gap between blockchain innovation and
              enterprise adoption. We connect Web3 projects with Fortune 500
              companies, NGOs, and government entities - creating real-world
              utility for decentralized technology.
            </p>
            <p>
              Our track record includes facilitating grants in excess of €4
              million through DevxDAO and XPRIZE, advising on DAO governance
              structures, and representing Web3 projects at the World Economic
              Forum in Davos.
            </p>
          </div>
        </div>
      ...
      <section className="relative section-light overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-14">
            ...
            >
              What We{" "}
              <span style={{ color: "oklch(0.55 0.15 30)" }}>Build</span>
            </h2>
          </div>
      ...
      <section className="relative section-dark overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            Our blockchain article series - deep dives into enterprise
            blockchain adoption, supply chain transformation, and the obstacles
            to a world-changing trajectory.
          </p>
          <div className="space-y-3">
            {publishedInsights.map((insight) => (
              ...
              >
                <span
                  className="text-sm text-white/80 font-medium group-hover:text-white transition-colors"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  {insight.title}
                </span>
      ...
      <section className="relative section-light overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 text-center">
          ...
          >
            Compensation tied to percentage of value created. We convene the
            right people and create real bridges between Web3 innovation and
            enterprise adoption.
          </p>
          <div className="mt-12 grid sm:grid-cols-3 gap-6">
            {[
              ...
              {
                label: "Commitment",
                value: "Right person in the room from all sides",
              },
              {
                label: "Key Value",
                value: "Non-dilutive capital & zero-cost transformative tech",
              },
            ].map((item) => (
              <div
                key={item.label}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {relatedPosts.map((post) => (
              ...
              >
                ...
                <h3
                  className="mt-3 text-base font-bold tracking-tight line-clamp-2"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  {post.title}
                </h3>
