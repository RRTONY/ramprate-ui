...
function sumBudgetCategories(values: ActivePharmFormValues): number {
  return values.budget.categories.reduce(
...
export function ActivePharmForm() {
  ...
  const showReconcileNote =
    centralTotal > 0 && categorySum > centralTotal * 1.1;

  const topPriorities = [...PRIORITY_ITEMS]
    .map((p) => ({
      label:
        p.key === "other" ? values.priorities.otherLabel || p.label : p.label,
    ...
    return (
      <div className="apf-root">
        <div className="apf-success-view">
          ...
          <p>
            Thanks — this gives RampRate what it needs to start the baseline
            review. Someone will follow up on any line items that need a closer
            look before the supplier interviews begin.
          </p>
          <div className="apf-success-meta">
            Submitted {new Date().toLocaleString()} · {values.suppliers.length}{" "}
            supplier
      ...
      <div className="apf-app">
        <aside className="apf-rail">
          ...
          <p className="apf-rail-heading">
            Supply chain baseline intake, prepared for TheActivePharm. Fifteen
            minutes, in five short parts.
          </p>
          ...
          <div className="apf-rail-footer">
            Questions about any field? Reach your RampRate contact directly —
        ...
        <main className="apf-main">
          <form onSubmit={handleSubmit}>
            {step === 0 && (
              <section className="apf-panel">
                <div className="apf-panel-eyebrow">
                  Part one of {totalSteps}
                </div>
                <h2>Respondent &amp; budget</h2>
                <p className="apf-panel-intro">
                  Start with who&apos;s filling this out, then give us a
                  top-level read on annual spend across your health-products
                  supply chain. Estimates are fine — we&apos;ll refine this
                  together.
                </p>
                  ...
                  <div className="apf-field-grid">
                    <div className="apf-field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("respondent.name", e.target.value)
                        }
                      />
                      {errors.respondent?.name && (
                        <span className="apf-error-text">
                          {errors.respondent.name}
                        </span>
                      )}
                    </div>
                    <div className="apf-field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("respondent.email", e.target.value)
                        }
                      />
                    ...
                    <div className="apf-field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("respondent.phone", e.target.value)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="apf-section-block">
                  ...
                  <p className="apf-section-note">
                    Current or upcoming fiscal year, in US$. Include everything
                    centrally managed, plus a rough estimate of anything handled
                    at the clinic or provider level.
                  </p>
                  <div className="apf-field-grid">
                    <div className="apf-field">
                      <label htmlFor="budgetCentral">
                        Total centralized supply chain spend
                      </label>
                      <div
                        className={`apf-money-field ${values.budget.centralTotal ? "apf-filled" : ""}`}
                      >
                        <input
                          type="number"
                          min={0}
                          ...
                          onChange={(e) =>
                            setFieldValue("budget.centralTotal", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    <div className="apf-field">
                      ...
                      <div
                        className={`apf-money-field ${values.budget.decentralTotal ? "apf-filled" : ""}`}
                      >
                        <input
                          type="number"
                          min={0}
                ...
                <div className="apf-section-block">
                  ...
                  <p className="apf-section-note">
                    An approximate annual dollar figure per category.
                    Doesn&apos;t need to be exact — it just needs to be
                    directionally right.
                  </p>
                  ...
                  {showReconcileNote && (
                    <p className="apf-reconcile-note">
                      That&apos;s more than your top-line total above — worth a
                      second look, but not a blocker.
                    </p>
                  )}
                </div>
              </section>
            ...
            {step === 1 && (
              <section className="apf-panel">
                <div className="apf-panel-eyebrow">
                  Part two of {totalSteps}
                </div>
                <h2>Priorities</h2>
                <p className="apf-panel-intro">
                  Two open questions, then a quick ranking. This shapes which
                  suppliers and categories we look at first.
                </p>

                <div className="apf-section-block">
                  <div className="apf-field">
                    <label htmlFor="priorityInitiatives">
                      Top initiatives for the next 12 months that would involve
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFieldValue("priorities.initiatives", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="apf-section-block">
                  <div className="apf-field">
                    <label htmlFor="prioritySavings">
                      If 10–20% of current supplier spend were freed up, what
                      would you fund with the savings?
                    </label>
                    <textarea
                      id="prioritySavings"
                      ...
                      onChange={(e) =>
                        setFieldValue("priorities.savingsUse", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="apf-section-block">
                  ...
                  <p className="apf-section-note">
                    1 is least important, 10 is most important. Move the sliders
            ...
            {step === 2 && (
              <section className="apf-panel">
                <div className="apf-panel-eyebrow">
                  Part three of {totalSteps}
                </div>
                <h2>Supplier inventory</h2>
                <p className="apf-panel-intro">
                  One entry per supplier above roughly $50K in annual spend —
                  compounding pharmacies, API/peptide sources, testing labs,
                  packaging, logistics, genomic testing, CRO or regulatory
                  partners, device manufacturers. Group anything smaller under
                  &quot;Other&quot; at the end.
                </p>
                  ...
                  <div className="apf-card" key={i}>
                    ...
                    <div className="apf-field-grid" style={{ marginTop: 14 }}>
                      ...
                      <div className="apf-field">
                        ...
                        <div
                          className={`apf-money-field ${s.spend ? "apf-filled" : ""}`}
                        >
                          <input
                            type="number"
                            min={0}
                      ...
                      <div className="apf-field">
                        <label>
                          States licensed / served{" "}
                          <span className="apf-optional">(if applicable)</span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="apf-field apf-span-2">
                        <label>
                          ...
                          <span className="apf-optional">
                            (PCAB, NABP, DEA, cGMP, ISO 13485, CLIA, etc.)
                          </span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="apf-field apf-span-2">
                        <label>
                          ...
                          <span className="apf-optional">
                            (scale-up, termination, re-bid, new SKU…)
                          </span>
                        </label>
                        <textarea
                      ...
                      <div className="apf-field apf-span-2">
                        <label>
                          Other notes{" "}
                          <span className="apf-optional">(optional)</span>
                        </label>
                        <textarea
                          value={s.notes}
                          onChange={(e) =>
                ...
                <p className="apf-item-count">
                  {values.suppliers.length} supplier
                  {values.suppliers.length === 1 ? "" : "s"} added
                </p>
              </section>
            )}
            ...
            {step === 3 && (
              <section className="apf-panel">
                <div className="apf-panel-eyebrow">
                  Part four of {totalSteps}
                </div>
                <h2>Growth &amp; capacity expansion</h2>
                <p className="apf-panel-intro">
                  Optional — only fill this in if growth or capacity expansion
                  (new states, a new product line, M&amp;A integration, rising
                  demand) is actually part of this engagement.
                </p>
                ...
                <div className="apf-section-block">
                  <div className="apf-field-grid">
                    <div className="apf-field apf-span-2">
                      <label>
                        Is growth / capacity expansion a driver for this
                        engagement?
                      </label>
                      <select
                        value={values.growth.isDriver}
                        onChange={(e) =>
                          setFieldValue("growth.isDriver", e.target.value)
                        }
                      >
                        <option value="">Select one</option>
                    ...
                    <div className="apf-field apf-span-2">
                      <label>
                        ...
                        <span className="apf-optional">
                          (e.g. entering new states, new product line, M&amp;A
                          integration, demand increase)
                        </span>
                      </label>
                      <textarea
                ...
                <div className="apf-section-block">
                  ...
                  <p className="apf-section-note">
                    One row per geography/category that&apos;s scaling — current
                    vs. desired volume, target date, and whether your existing
                    supplier(s) can flex to meet it.
                  </p>
                  ...
                  {values.growth.rows.map((r, i) => (
                    <div className="apf-card" key={i}>
                      ...
                      <div className="apf-field-grid" style={{ marginTop: 14 }}>
                        ...
                        <div className="apf-field apf-span-2">
                          <label>
                            Can current supplier(s) flex to meet this?
                          </label>
                          <select
                            value={r.canFlex}
                            onChange={(e) =>
                              setFieldValue(
                                `growth.rows[${i}].canFlex`,
                                e.target.value,
                              )
                            }
                          >
                  ...
                  <p className="apf-item-count">
                    {values.growth.rows.length} row
                    {values.growth.rows.length === 1 ? "" : "s"} added
                  </p>
                </div>
                ...
                <div className="apf-section-block">
                  ...
                  <p className="apf-section-note">
                    Does an expansion budget exist that&apos;s separate from the
                    current run-rate spend covered in the budget breakdown
                    above?
                  </p>
                  <div className="apf-field-grid">
                    <div className="apf-field">
                    ...
                    <div className="apf-field">
                      ...
                      <div
                        className={`apf-money-field ${values.growth.budgetAmount ? "apf-filled" : ""}`}
                      >
                        <input
                          type="number"
                          min={0}
                          ...
                          onChange={(e) =>
                            setFieldValue("growth.budgetAmount", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    <div className="apf-field apf-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("growth.budgetPeriod", e.target.value)
                        }
                      />
                    </div>
                  </div>
            ...
            {step === 4 && (
              <section className="apf-panel">
                <div className="apf-panel-eyebrow">
                  Part five of {totalSteps}
                </div>
                <h2>Review &amp; submit</h2>
                <p className="apf-panel-intro">
                  A quick summary of what you&apos;re about to send. Go back to
                  any part to make changes.
                </p>
                ...
                <div className="apf-section-block" style={{ marginTop: 24 }}>
                  <div className="apf-review-block">
                    ...
                    <div className="apf-review-row">
                      ...
                      <span className="apf-v">
                        {fmtUSD(values.budget.centralTotal)}
                      </span>
                    </div>
                    <div className="apf-review-row">
                      <span className="apf-k">
                        Decentralized estimate (stated)
                      </span>
                      <span className="apf-v">
                        {fmtUSD(values.budget.decentralTotal)}
                      </span>
                    </div>
                    <div className="apf-review-row">
                    ...
                    <ul className="apf-review-list">
                      {values.suppliers.map((s, i) => (
                        <li key={i}>
                          ...
                          <span className="apf-tag">
                            {s.category || "No category selected"}
                          </span>
                        </li>
                      ))}
                    </ul>
                ...
                <div className="apf-confirm-row">
                  <input
                    ...
                    onChange={(e) =>
                      setFieldValue("confirmAccurate", e.target.checked)
                    }
                  />
                  <label htmlFor="confirmAccurate">
                    To the best of my knowledge, the information above is
                    accurate as of today, and I understand RampRate may follow
                    up on specific line items.
                  </label>
                </div>
                ...
                {submitState === "error" && (
                  <p className="apf-error-text">
                    Something went wrong sending this — please try again, or
                    reach your RampRate contact directly.
                  </p>
                )}
              </section>
            )}
