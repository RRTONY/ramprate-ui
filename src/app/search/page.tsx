...
export default async function SearchPage({
  ...
  if (q) {
    ...
    const STOP = new Set([
      ...
      'with','by','from','up','is','it','its','this','that','are','was',
      'be','do','how','what','why','when','where','who',
    ])
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {thinkingPosts.map(post => (
                <SearchPostCard key={post._id} post={post} basePath="/thinking" />
              ))}
            </div>
          </section>
        )}
      ...
      {post.mainImage ? (
        ...
        >
          <div
            ...
            style={{ border: '1px solid oklch(0.82 0.15 75)', background: 'transparent' }}
          />
          <div
        ...
        <div className="flex items-center gap-2 mb-3">
          <span
            ...
            style={{
              ...
              color: basePath === '/thinking' ? 'rgba(160,175,255,0.8)' : 'var(--gold)',
              border:
                basePath === '/thinking'
...
function EmptyQuery() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 sm:py-28 text-center px-4">
      ...
      >
        Search blog posts, articles, and insights on enterprise IT sourcing, cloud
        infrastructure, Web3, and emerging technology.
      </p>
