...
const advisoryServices = [
  {
    num: "01",
    title: "The Audit",
    desc: "Validate you can deliver on core promises. Build a roadmap for growth.",
  },
  {
    num: "02",
    title: "Positioning",
    desc: "Core value proposition clarity for all your audiences - investors, customers, partners.",
  },
  {
    num: "03",
    title: "Marketing Cleanup",
    desc: "Investor decks, white papers, website made clear and compelling.",
  },
  {
    num: "04",
    title: "Critical Partnerships",
    desc: "Complementary tech, channels, accelerators connected through our network.",
  },
  {
    num: "05",
    title: "Recruiting",
    desc: "Employees, contractors, advisors, service providers - the right people at the right time.",
  },
  {
    num: "06",
    title: "Social Impact Strategies",
    desc: "Find the lever to do good. Measure and report your impact.",
  },
  {
    num: "07",
    title: "Strategic Research",
    desc: "Customers, competitors, partners identified. Markets quantified with data.",
  },
  {
    num: "08",
    title: "Strategy Validation",
    desc: "Staffing, product roadmap, partners pressure-tested with data.",
  },
  {
    num: "09",
    title: "Token / IPO Amplification",
    desc: "Liquidity management, exchange listings, price/volume optimization.",
  },
  {
    num: "10",
    title: "Advisory Board Membership",
    desc: "Tony Greenberg and network lend name and reputation publicly to your company.",
  },
];
    ...
    <main>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="max-w-3xl">
            ...
            >
              Anchor clients, advisors, capital, impact, strategy, and dispute
              resolution - all aligned to your vision. For Founders &
              Impactpreneurs.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                {
                  value: "Comp",
                  label: "Equity/tokens + commission + retainers",
                },
              ].map((stat) => (
      ...
      <section className="relative section-warm overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          >
            <p>
              Syzygy: when celestial bodies align to create extraordinary
              gravitational force. We align founders with the customers,
              capital, and connections that create escape velocity.
            </p>
            <p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-14">
            ...
            >
              ...
              <span style={{ color: "oklch(0.55 0.15 30)" }}>Win</span>
            </h2>
          </div>
      ...
      <section className="relative section-warm overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8">
          ...
          >
            The Full{" "}
            <span style={{ color: "oklch(0.55 0.15 30)" }}>Playbook</span>
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {advisoryServices.map((s) => (
              ...
              >
                <div
                  className="text-2xl font-bold shrink-0 w-10"
                  style={{
                    fontFamily: "var(--font-mono)",
                    color: "oklch(0.55 0.15 30 / 0.2)",
                  }}
                >
                  {s.num}
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  {
                    label: "Equity / Tokens",
                    desc: "We take a stake in your success, aligning our incentives with your growth trajectory.",
                  },
                  {
                    label: "Commission on Revenue",
                    desc: "We earn when you earn - tied to the revenue we help generate through our network.",
                  },
                  {
                    label: "Project Fees / Retainers",
                    desc: "Structured engagements for specific deliverables with clear milestones.",
                  },
                ].map((f) => (
                  <div
                    key={f.label}
                ...
                {[
                  {
                    step: "1",
                    title: "Review",
                    desc: "We review your presentations, investor materials, and product documentation.",
                  },
                  {
                    step: "2",
                    title: "Down-Select",
                    desc: "We determine fit based on impact potential, market opportunity, and team capability.",
                  },
                  {
                    step: "3",
                    title: "Deep Dive",
                    desc: "Interviews with your customers, investors, and partners to validate the opportunity.",
                  },
                  {
                    step: "4",
                    title: "Activate",
                    desc: "We deploy our network, advisory board, and enterprise connections on your behalf.",
                  },
                ].map((s) => (
