...
const spyPillars = [
  {
    ...
    desc: "24 years of actual deal data across every major IT service category.",
  },
  {
    title: "Analyst Research",
    desc: "Integrated intelligence from Gartner, IDC, Telegeography, 451 Research.",
  },
  {
  ...
  },
  {
    ...
    desc: "Ongoing interviews with enterprise buyers for real-world performance data.",
  },
  {
...
const testimonials = [
  {
    quote:
      "RampRate was a risk-free proposition money-wise. If they didn't save or create us at least twice their initial fee we'd get a full refund. They hit 27% savings and the relationships are stronger than ever.",
    name: "Paul Santana",
  ...
  {
    quote:
      "RampRate simply got us better pricing and better SLA protections than we got for ourselves!",
    name: "Ryan Hughes",
  ...
  {
    quote:
      "They brought in two other providers, had all providers re-quote, and lowered overall prices between 17-36%. They helped us achieve breakthrough innovative best-of-breed SLA coverage.",
    name: "Charles Butler",
  ...
  {
    quote:
      "Since engaging them they have helped me significantly reduce my cost structure through several major outsourcing deals worth deep 8 figures. They made me look like a hero to my executive management.",
    name: "Peter Borner",
...
const services = [
  {
    ...
    desc: "Site selection, procurement, benchmarking across 80+ countries",
  },
  {
    label: "AI & GPU Compute",
    desc: "Cluster pricing, reserved vs. spot, liquid cooling, high-density power",
  },
  {
    label: "Cloud & Hybrid",
    desc: "AWS/Azure/GCP optimization, repatriation analysis, hybrid architecture",
  },
  {
    label: "Edge Infrastructure",
    desc: "Edge location intelligence, latency mapping, micro-DC procurement",
  },
  {
    label: "CDN & Content Delivery",
    desc: "Multi-CDN architecture, published market research, pricing intelligence",
  },
  {
    label: "Telecom & Connectivity",
    desc: "Billing audits, carrier negotiations, Master Contractor model",
  },
  {
    label: "Managed Services",
    desc: "Cloud utility pricing, SLA benchmarking, outsource decisions",
  },
  {
    label: "IT Strategy & Planning",
    desc: "5-year roadmaps, cloud vs. colo evaluation, technology planning",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
              ...
              >
                <div className="flex items-start gap-4 p-5 sm:p-6">
                  <div
                    ...
                    style={{ background: "rgba(211,171,76,0.1)" }}
                  >
                    <span
                  ...
                  <div
                    ...
                    style={{
                      transform: expandedQ === q.num ? "rotate(45deg)" : "none",
                    }}
                  >
                    <span className="text-white/40 text-sm leading-none">
                      +
                    </span>
                  </div>
                </div>
          ...
          <div
            ...
            style={{
              background: "rgba(211,171,76,0.08)",
              borderColor: "rgba(211,171,76,0.2)",
            }}
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                >
                  ...
                  Every answer we give is backed by someone who closed that
                  exact deal in the last 90 days. Not a model. Not a forecast. A
                  person who sat across the table and signed.
                </p>
                <Link
                  href="/contact"
      ...
      <section className="relative section-warm overflow-hidden py-20 sm:py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-16">
            ...
            >
              AI is brilliant at pattern recognition, benchmarking, and anomaly
              detection. But deals are closed by people who understand leverage,
              relationships, and timing. We bring both.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={step.step} className="relative">
                ...
                {i < 2 && (
                  <div
                    className="hidden md:flex absolute top-1/2 -right-4 z-10 items-center justify-center w-8 text-center"
                    style={{ color: "oklch(0.55 0.15 30)", opacity: 0.3 }}
                  >
                    <svg
                      width="20"
                      height="20"
      ...
      <section className="relative section-light overflow-hidden py-20 sm:py-28">
        <div
          className="absolute -bottom-32 -left-32 w-[280px] h-[280px] rounded-full opacity-15 pointer-events-none"
          style={{ background: "oklch(0.82 0.15 75)", filter: "blur(80px)" }}
        />
        <div
          className="absolute top-20 -right-20 w-[160px] h-[160px] rounded-full opacity-15 pointer-events-none"
          style={{ background: "oklch(0.55 0.15 30)", filter: "blur(80px)" }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="mb-14">
            ...
            <p
              className="mt-4 text-base max-w-3xl leading-relaxed"
              style={{
                color: "oklch(0.45 0.02 50)",
                fontFamily: "var(--font-body)",
              }}
            >
              We grade, benchmark, audit, locate, and strategize across every
              kind of infrastructure deal - from a single edge cabinet to a
              100MW AI campus.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                This isn&apos;t an analyst report. It&apos;s a living database
                of what buyers actually paid - updated with every deal we close.
