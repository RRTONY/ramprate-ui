            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-display text-lg font-bold">Book a Call</h3>
                </div>
                <p className="font-body text-sm leading-relaxed mb-5 text-[oklch(0.45_0.02_50)]">
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-body text-xs font-medium uppercase tracking-wider mb-1 text-[oklch(0.4_0.02_50)]">Email</div>
                    <a
                      href={`mailto:${email}`}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-body text-xs font-medium uppercase tracking-wider mb-1 text-[oklch(0.4_0.02_50)]">Phone</div>
                    <a
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="font-display text-base font-bold">Office Locations</h3>
                </div>
                <div className="space-y-4">
                  {offices.map((o) => (
                    <div key={o.city} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-body text-sm font-semibold text-[oklch(0.3_0.02_50)]">{o.city}</div>
                        <div className="font-body text-xs text-[oklch(0.5_0.02_50)]">{o.role}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="rounded-xl p-7 border bg-[oklch(0.97_0.01_80)] border-[rgba(100,60,30,0.1)]">
                <h4 className="font-display text-base font-bold mb-2">The RampRate Guarantee</h4>
                <p className="font-body text-sm leading-relaxed text-[oklch(0.45_0.02_50)]">
              ...
              {/* Assessment */}
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                <h4 className="font-display text-base font-bold mb-3">Start With an Assessment</h4>
                <p className="font-body text-xs leading-relaxed mb-4 text-[oklch(0.45_0.02_50)]">
