...
const FALLBACK_METADATA: Metadata = {
  title: "Contact",
  description:
    "Start a conversation with RampRate. The first conversation is always free.",
  keywords: [
    "contact RampRate",
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm">
                ...
                <p className="font-body text-sm leading-relaxed mb-5 text-[oklch(0.45_0.02_50)]">
                  Prefer to schedule directly? Pick a time that works for you
                  and one of our principals will be on the call.
                </p>
                <a
              ...
              <div className="bg-white rounded-xl p-7 border border-black/5 shadow-sm space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-body text-xs font-medium uppercase tracking-wider mb-1 text-[oklch(0.4_0.02_50)]">
                      Email
                    </div>
                    <a
                      href={`mailto:${email}`}
                ...
                <div className="space-y-4">
                  {offices.map((o) => (
                    <div key={o.city} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-body text-sm font-semibold text-[oklch(0.3_0.02_50)]">
                          {o.city}
                        </div>
                        <div className="font-body text-xs text-[oklch(0.5_0.02_50)]">
                          {o.role}
                        </div>
                      </div>
                    </div>
              ...
              <div className="rounded-xl p-7 border bg-[oklch(0.97_0.01_80)] border-[rgba(100,60,30,0.1)]">
                ...
                <p className="font-body text-sm leading-relaxed text-[oklch(0.45_0.02_50)]">
                  The audit is always free. If we don&apos;t deliver 300%+ ROI
                  on our sourcing engagements, you don&apos;t pay. We put skin
                  in the game because we believe in what we do.
                </p>
              </div>
