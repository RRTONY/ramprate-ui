...
> = {
  tip: {
    bg: "rgba(130,180,80,0.08)",
    border: "oklch(0.6 0.15 140)",
    icon: "💡",
    label: "Tip",
  },
  info: {
    bg: "rgba(60,120,220,0.08)",
    border: "oklch(0.55 0.18 250)",
    icon: "ℹ️",
    label: "Info",
  },
  warning: {
    bg: "rgba(220,160,0,0.08)",
  ...
  success: {
    ...
    border: "oklch(0.6 0.18 160)",
    icon: "✅",
    label: "Success",
  },
  error: {
    bg: "rgba(220,60,60,0.08)",
    border: "oklch(0.55 0.22 20)",
    icon: "❌",
    label: "Error",
  },
};
...
export const portableTextComponents: PortableTextComponents = {
  types: {
    ...
    spacer: ({ value }) => {
      ...
      return (
        <div
          style={{ height: heightMap[value?.height || "md"] }}
          aria-hidden="true"
        />
      );
    },
    ...
    button: ({ value }) => {
      ...
      const styleMap: Record<string, React.CSSProperties> = {
        ...
        secondary: {
          ...
          border: "2px solid oklch(0.55 0.15 30)",
      ...
      return (
        <div
          style={{ display: "flex", justifyContent: justify, margin: "24px 0" }}
        >
          <a
            href={value.url}
          ...
          {value.caption && (
            <figcaption
              ...
              style={{
                ...
                clear: isLeft || isRight ? "both" : undefined,
              }}
            >
              {value.caption}
            </figcaption>
  ...
  block: {
    ...
    textCenter: ({ children }) => (
      <p
        className="mb-5 leading-relaxed text-center"
        style={{
          color: "rgba(255,255,255,0.8)",
          fontFamily: "var(--font-body)",
        }}
    ...
    textRight: ({ children }) => (
      <p
        className="mb-5 leading-relaxed text-right"
        style={{
          color: "rgba(255,255,255,0.8)",
          fontFamily: "var(--font-body)",
        }}
  ...
  list: {
    bullet: ({ children }) => (
      <ul
        className="list-disc list-outside ml-6 mb-5 space-y-1.5"
        style={{
          color: "rgba(255,255,255,0.8)",
          fontFamily: "var(--font-body)",
        }}
    ...
    number: ({ children }) => (
      <ol
        className="list-decimal list-outside ml-6 mb-5 space-y-1.5"
        style={{
          color: "rgba(255,255,255,0.8)",
          fontFamily: "var(--font-body)",
        }}
  ...
  marks: {
    ...
    em: ({ children }) => (
      <em style={{ color: "rgba(255,255,255,0.9)" }}>{children}</em>
    ),
    underline: ({ children }) => (
