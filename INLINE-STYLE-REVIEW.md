...
16. Attorney RFI retains a bounded mix of fixed public typography and interactive form controls. Its hero, application-success message, form headings, sidebar headings, practice-area heading, and interactive-choice controls now use the approved display and body utilities. Remaining inline styles are still under review and include field, selection, and submission presentation that must preserve form value, selection, and submission behavior.
